...
public class PinView {
    ...
    public PinView(LayoutInflater inflater, int resId, ViewGroup container, Bundle savedInstanceState) {
        ...
        ret.findViewById(R.id.clear).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        ret.findViewById(R.id.clear).setOnLongClickListener(new View.OnLongClickListener() {
            @Override
        ...
        AppCompatButton cancel = (AppCompatButton) ret.findViewById(R.id.cancel);
