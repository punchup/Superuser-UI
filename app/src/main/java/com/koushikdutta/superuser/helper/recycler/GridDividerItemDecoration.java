...
public class GridDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private void drawHorizontalDividers(Canvas canvas, RecyclerView parent) {
        ...
        for (int i = 0; i < count - 1; i++) {
            ...
            //Toast.makeText(parent.getContext(), String.valueOf(lastRowChildIndex), Toast.LENGTH_SHORT).show();
            ...
            if (firstRowChild != null && lastRowChild != null) {
                ...
                int dividerRight = dividerLeft + mHorizontalDivider.getIntrinsicWidth();
    ...
    private void drawVerticalDividers(Canvas canvas, RecyclerView parent) {
        ...
        for (int i = 0; i <= rowCount; i++) {
            ...
            if (leftmostChild != null && rightmostChild != null) {
                ...
                int dividerBottom = leftmostChild.getBottom();
    ...
    private void drawHorizontal(Canvas c, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            final int right = left + mHorizontalDivider.getIntrinsicHeight();
